...
import 'package:simple_weather_app/weather/data_layer/repository/weather_repository.dart';
...
import 'package:simple_weather_app/weather/domain_layer/use_cases/get_weather_by_city.dart';

void main() async {
  BaseRemoteDataSource baseRemoteDataSource = RemoteDataSource();
  BaseWeatherRepository baseWeatherRepository =
      WeatherRepository(baseRemoteDataSource);
  //call useCase in presentation layer here
  Weather weather =
      await GetWeatherByCityName(baseWeatherRepository).execute('egypt');
